...
pub const BASE: u16 = 0x400;

pub const MODE: u16 = BASE + 0x00;
pub const COMMAND: u16 = BASE + 0x01;
pub const RXBUF_SIZE: u16 = BASE + 0x1E;
pub const TXBUF_SIZE: u16 = BASE + 0x1F;
pub const TX_FREE_SIZE: u16 = BASE + 0x20;
pub const TX_DATA_WRITE_PTR: u16 = BASE + 0x24;
pub const RECVD_SIZE: u16 = BASE + 0x26;
pub const RX_DATA_READ_PTR: u16 = BASE + 0x28;
pub const SOCKET_INTR_MASK: u16 = BASE + 0x2C;
